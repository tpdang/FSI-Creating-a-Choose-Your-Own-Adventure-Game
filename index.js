// Your Code Here
let firstAnswer  = window.prompt('A powerful sorcerer, you arrive at the entrance to dark cave, \
which quickly forks into two passages \
headed in opposite directions. Do you head left or right?')
if(firstAnswer === 'left'){
    ...
    if(secondAnswer == 'follow'){
        let thirdAnswer = window.prompt('You follow the cat to a colony of cats, nestled in a fort of warm blankets and subsisting off of inexplicably warm soup. They are content with you staying, but you wonder if you should alert the world to this magical safe haven. Do you "stay" or "alert" the world?')
        if(thirdAnswer == 'stay'){
    ...
    let secondAnswer = window.prompt('You come across a snoring dragon. On the other side of him, you see a shiny chest of treasure. Another path would lead you away from the dragon altogether.Do you "pass" the dragon or move "away" from the dragon?')
